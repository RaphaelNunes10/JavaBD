...
public class HistoricoClientes extends JFrame {
    ...
    public static JTextField tfPesquisa = new JTextField();
    static JButton btPesquisar = new JButton("Pesq...");

    static JLabel lbRg = new JLabel("RG: ");
    public static JLabel lbCampoRg = new JLabel("-");

    static JLabel lbNome = new JLabel("Nome: ");
    public static JLabel lbCampoNome = new JLabel("-");

    static JLabel lbEmail = new JLabel("E-mail: ");
    public static JLabel lbCampoEmail = new JLabel("-");

    static JLabel lbPhone = new JLabel("Phone: ");
    public static JLabel lbCampoPhone = new JLabel("-");

    static JLabel lbPhone2 = new JLabel("Phone (alternativo): ");
    public static JLabel lbCampoPhone2 = new JLabel("-");

    static JLabel lbEndereco = new JLabel("Endereco: ");
    static JLabel lbCampoEndereco = new JLabel("-");

    public static Object[][] estadia = {{"", ""}};

    public static String[] colunasEstadia = {"Entrada", "Sa�da"};

    public static DefaultTableModel modeloEstadia = new DefaultTableModel();

    public static JTable tbEstadia = new JTable(modeloEstadia);
    ...
    public HistoricoClientes() {
        ...
        add(tfPesquisa);
        btPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("search.png")));
